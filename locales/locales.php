...
if ( ! class_exists( 'GP_Locales' ) ) :
	...
	class GP_Locales {
		...
		private function _populate_locales() {
			...
			$this->locales['ha']->english_name = 'Hausa';
			...
			$this->locales['ha']->facebook_locale = 'ha_NG';
			...
			$this->locales['ky'] = new GP_Locale();
			$this->locales['ky']->english_name = 'Kirghiz';
			$this->locales['ky']->native_name = 'кыргыз тили';
			$this->locales['ky']->lang_code_iso_639_1 = 'ky';
			$this->locales['ky']->lang_code_iso_639_2 = 'kir';
			$this->locales['ky']->country_code = 'kg';
			$this->locales['ky']->wp_locale = 'ky_KY';
			$this->locales['ky']->slug = 'ky';
			$this->locales['ky']->nplurals = 1;
			$this->locales['ky']->plural_expression = '0';
